...
import 'home_page_template_model.dart';
export 'home_page_template_model.dart';

class HomePageTemplateWidget extends StatefulWidget {
  const HomePageTemplateWidget({super.key});

  @override
  State<HomePageTemplateWidget> createState() => _HomePageTemplateWidgetState();
}

class _HomePageTemplateWidgetState extends State<HomePageTemplateWidget>
    with TickerProviderStateMixin {
  late HomePageTemplateModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomePageTemplateModel());

...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    frameAuthUserSubject.add(
      FrameAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<FrameAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  FrameAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = FrameAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    frameAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
